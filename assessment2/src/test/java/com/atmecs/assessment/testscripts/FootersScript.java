...
public class FootersScript extends TestBase{
	...
	@Test(priority = 1, dataProvider = "footervalidation", dataProviderClass = TestDataInputOne.class)
	...
	public void aboutusfooterValidation(String[] ar) {
		if (count == 0) {
			CommonUtlity.clickElement(loc.getlocator("lloc.aboutus.header.click"));
		}
		count++;
		Footer.clickOnHeaders(count, ar);
		if (count == 4) {
